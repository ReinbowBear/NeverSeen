...
{
    public static readonly Dictionary<string, AsyncOperationHandle> handleAssets = new();
    ...
    public static async Task<T> LoadAssetAsync<T>(string key) where T : UnityEngine.Object
    {
        ...
        var loadingTask = new TaskCompletionSource<AsyncOperationHandle>();
        loadingTasks[key] = loadingTask.Task;
