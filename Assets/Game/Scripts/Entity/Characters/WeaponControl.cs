...
public class WeaponControl
{
    ...
    private List<Weapon> Actions = new List<Weapon>();
    private Coroutine myCoroutine;


    public void ChoseAbility(int index)
    {
        Weapon ability = character.inventory.abilities[index];
    ...
    public void AddAction(Weapon ability)
    {
        Actions.Add(ability);
    ...
    public void AddAbility(Weapon newAbility, byte index)
    {
