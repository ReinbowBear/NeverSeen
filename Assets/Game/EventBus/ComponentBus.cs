...
readonly struct EventKey : IEquatable<EventKey>
{
...
sealed class ComponentSubscriber<T> : IComponentSubscriber where T : Component
{
    ...
    {
        return callback == (Action<T>)cb;
    }
}


interface IComponentSubscriber
{
